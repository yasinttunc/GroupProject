...
public class ResourcesController {
    ...
    private void populate(HBox container, ScrollPane scrollPane, List<ResourceRow> resources, Function<ResourceRow, VBox> cardBuilder) {
        if (resources.isEmpty()) {
            ...
            VBox empty = new VBox();
            empty.setStyle("-fx-background-color: white; -fx-padding: 15; -fx-background-radius: 12; -fx-border-radius: 12; -fx-border-color: #DDE3EE;");
    ...
    private VBox buildStudyRoomCard(ResourceRow resource) {
        VBox card = new VBox();
        card.setSpacing(5);
        card.setStyle("-fx-background-color: white; -fx-padding: 15; -fx-background-radius: 12; -fx-border-radius: 12; -fx-border-color: #DDE3EE;");
        card.setPrefWidth(150);
        
        Label nameLabel = new Label(resource.getName());
        nameLabel.setStyle("-fx-font-weight: bold; -fx-text-fill: #243044;");
        ...
        bookButton.setStyle("-fx-background-color: #4F7CFF; -fx-text-fill: white; -fx-background-radius: 8; -fx-cursor: hand;");
