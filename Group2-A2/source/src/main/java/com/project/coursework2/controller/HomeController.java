    ...
    private void loadMaintenanceAlerts() {
        ...
        try (Connection conn = getConnection();
            ...
            while (rs.next()) {
                ...
                alert.setStyle("-fx-font-size: 11px; -fx-text-fill: #243044; -fx-background-color: #EEF4FF; -fx-background-radius: 8; -fx-border-radius: 8; -fx-border-color: #C9D8FF; -fx-border-width: 1; -fx-padding: 6 8;");
